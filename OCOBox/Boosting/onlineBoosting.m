function [models, alphas] = onlineBoosting(baseLearner, X_train, y_train, numRounds)
    % ONLINEBOOSTING Implements the Online Boosting algorithm.
    %   [models, alphas] = onlineBoosting(baseLearner, X_train, y_train, numRounds)
    %   trains an ensemble of base learners using the Online Boosting algorithm.
    %
    % Inputs:
    ...
    for t = 1:numRounds
        ...
        models{t} = baseLearner(X_train, y_train);
